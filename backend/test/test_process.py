...
class TestProcess:
    ...
    def test_process_image_success(self, client, sample_image, auth_headers):
        """测试全链路图片处理"""
        ...
        response = client.post("/api/v1/process/image", files=files, data=data, headers=auth_headers)
